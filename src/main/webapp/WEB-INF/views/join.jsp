...
<body>
    ...
    <div class="mainContainer" align="center">
        ...
        <div style="width:80%; padding:10px;">
            ...
            <div style="display:inline-block;">
                <input type="text" name="trade_cd" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');"/>
            </div>
        </div>
        <div style="width:80%; padding:10px;">
            <div style="display:inline-block;">
        ...
        <div style="width:80%; padding:10px;">
            ...
            <div style="display:inline-block;">
                <input type="text" name="tradesub_cd" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');"/>
            </div>
        </div>
        <div style="width:80%; padding:10px;">
            <div style="display:inline-block;">
            ...
            <div style="display:inline-block;">
                <input type="text" name="tradesub_nm">
            </div>
        </div>
        <div style="width:80%; padding:10px;">
            <div style="display:inline-block;">
